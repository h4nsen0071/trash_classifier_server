...
#define WIFI_SSID           "AMERICANO COFFEE"
...
#define SERVER_HOST         "api.smartbin.live"
#define SERVER_PORT         443
#define SERVER_PATH         "/classify"
...
//
// FRAMESIZE_QVGA    = 320x240  ⭐ KHUYẾN NGHỊ (đã test OK)
...
// ⚠️ BẬT DEBUG ĐỂ TEST RIÊNG CAM (comment khi chạy với Controller)
