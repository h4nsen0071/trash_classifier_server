...
const char* servoController_getBinName(int binNumber) {
    switch (binNumber) {
        case BIN_RED:       return "Thùng Đỏ";
        case BIN_GREEN:     return "Thùng Xanh";
        case BIN_GRAY:      return "Thùng Xám";
...
const char* servoController_getWasteType(int binNumber) {
    switch (binNumber) {
        case BIN_RED:       return "Paper";     // Giấy
        case BIN_GREEN:     return "Plastic";   // Nhựa
        case BIN_GRAY:      return "Glass";     // Thủy tinh
        default:            return "Unknown";
    }
}
